...
/* ./.libs/lt-smooth_opengl3.c - temporary wrapper executable for .libs/smooth_opengl3.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1

   The smooth_opengl3 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "smooth_opengl3.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# smooth_opengl3 - temporary wrapper script for .libs/smooth_opengl3.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1\n", f);
  fputs ("#\n", f);
  fputs ("# The smooth_opengl3 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"smooth_opengl3.exe:smooth_opengl3:${LINENO}: libtool wrapper (GNU lib", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"smooth_opengl3.exe:smooth_opengl3:${LINENO}: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"smooth_opengl3.exe:smooth_opengl3:${LINENO}: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='smooth_opengl3.exe'\n", f);
