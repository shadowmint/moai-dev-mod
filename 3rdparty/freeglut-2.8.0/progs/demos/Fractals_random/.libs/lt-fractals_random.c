...
/* ./.libs/lt-fractals_random.c - temporary wrapper executable for .libs/fractals_random.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1

   The fractals_random program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "d:\\projects\\moai-dev\\3rdparty\\freeglut-2.8.0\\src\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "d;D:\\MinGW\\msys\\1.0\\projects\\moai-dev\\3rdparty\\freeglut-2.8.0\\src\\.libs;D:\\MinGW\\msys\\1.0\\local\\lib;D:\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "fractals_random.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# fractals_random - temporary wrapper script for .libs/fractals_random.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1\n", f);
  fputs ("#\n", f);
  fputs ("# The fractals_random program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../../../src/libglut.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"fractals_random.exe:fractals_random:${LINENO}: libtool wrapper (GNU l", f);
  fputs ("ibtool) 2.4.2 Debian-2.4.2-1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"fractals_random.exe:fractals_random:${LINENO}: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"fractals_random.exe:fractals_random:${LINENO}: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='fractals_random.exe'\n", f);
  ...
  fputs ("    PATH=d:/projects/moai-dev/3rdparty/freeglut-2.8.0/src/.libs:/usr/local/lib:", f);
  fputs ("/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"d:/projects/moai-dev/3rdparty/freeglut-2.8.0/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
