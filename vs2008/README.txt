...
1) Install the latest Direct X SDK
2) Click on the menu command Tools->Options->Projects and Solutions->VC++ Directories
3) Edit the value of Include files to include C:\Program Files\FMOD SoundSystem\FMOD Programmers API Win32\api\inc
4) Edit the value of Library files to include C:\Program Files\FMOD SoundSystem\FMOD Programmers API Win32\api\lib