...
/* ./.libs/lt-CallbackMaker.c - temporary wrapper executable for .libs/CallbackMaker.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1

   The CallbackMaker program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "CallbackMaker.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# CallbackMaker - temporary wrapper script for .libs/CallbackMaker.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1\n", f);
  fputs ("#\n", f);
  fputs ("# The CallbackMaker program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"CallbackMaker.exe:CallbackMaker:${LINENO}: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.2 Debian-2.4.2-1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"CallbackMaker.exe:CallbackMaker:${LINENO}: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"CallbackMaker.exe:CallbackMaker:${LINENO}: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='CallbackMaker.exe'\n", f);
