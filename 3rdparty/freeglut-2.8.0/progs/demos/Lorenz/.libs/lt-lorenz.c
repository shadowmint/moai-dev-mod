...
/* ./.libs/lt-lorenz.c - temporary wrapper executable for .libs/lorenz.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1

   The lorenz program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "lorenz.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# lorenz - temporary wrapper script for .libs/lorenz.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1\n", f);
  fputs ("#\n", f);
  fputs ("# The lorenz program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"lorenz.exe:lorenz:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debi", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"lorenz.exe:lorenz:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"lorenz.exe:lorenz:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
