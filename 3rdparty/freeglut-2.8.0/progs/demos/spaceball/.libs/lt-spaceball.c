...
/* ./.libs/lt-spaceball.c - temporary wrapper executable for .libs/spaceball.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1

   The spaceball program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "spaceball.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# spaceball - temporary wrapper script for .libs/spaceball.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1\n", f);
  fputs ("#\n", f);
  fputs ("# The spaceball program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"spaceball.exe:spaceball:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"spaceball.exe:spaceball:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"spaceball.exe:spaceball:${LINENO}: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
